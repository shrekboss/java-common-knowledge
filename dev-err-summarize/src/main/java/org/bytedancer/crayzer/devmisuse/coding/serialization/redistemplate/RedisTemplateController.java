package org.bytedancer.crayzer.devmisuse.coding.serialization.redistemplate;
...
public class RedisTemplateController {
    ...
    // - redisTemplate get User(name=zhuye, age=36)
    // - stringRedisTemplate get User(name=zhuye, age=36)
    @GetMapping("right")
