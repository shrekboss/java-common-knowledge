package org.bytedancer.crayzer.design_mode_pattern.creational.singleton.register;
...
public class RegisterSingletonChildA extends RegisterSingleton {
    public static RegisterSingletonChildA getInstance() {
        return (RegisterSingletonChildA) RegisterSingletonChildA
                .getInstance("org.bytedancer.crayzer.design_mode_pattern.creational.singleton.register.RegisterSingletonChildA");
    }
